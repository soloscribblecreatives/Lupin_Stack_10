...
var arrSurveyQuestions = {
   1: "Brand name for Lasmiditan migraine therapy?"
};
...
function open_page2(url,page_id,count){
	...
	document.getElementById("click_through").innerHTML='';
		...
		<div id="slide01_question01_choices01" class="control-group">\
			<label class="control control_radio"><div class="lbl_pos"></div><input type="radio" id="slide01_radio01_01" name="checkB01" value="Lasmitame"/><div class="control_indicator"id="radio01" onclick="option1()"></div></label>\
			<label class="control control_radio"><div class="lbl_pos"></div><input type="radio" id="slide01_radio01_02" name="checkB01" value="Lasmivow"/><div class="control_indicator"id="radio02" onclick="option2()"></div></label>\
			<label class="control control_radio"><div class="lbl_pos"></div><input type="radio" id="slide01_radio01_03" name="checkB01" value="Lasmithink"/><div class="control_indicator"id="radio03" onclick="option3()"></div></label>\
			<label class="control control_radio"><div class="lbl_pos"></div><input type="radio" id="slide01_radio01_04" name="checkB01" value="Lasminext"/><div class="control_indicator"id="radio04" onclick="option4()"></div></label>\
		</div>\
			<div class="submit_button" onclick="savedata(1,1,1);endTime1(1);hidesubmitonclick();"></div>\
		</div>';
